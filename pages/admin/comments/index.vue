...
export default {
	...
	methods: {
		loadComments () {
			axios
				.get('https://blog-nuxt-9b0a0.firebaseio.com/comments.json')
					.then((res)=>{
						let commentsArray = []
		...
		changeComment (comment) {
			...
			axios
				.put(`https://blog-nuxt-9b0a0.firebaseio.com/comments/${comment.id}.json`, comment)
		},
		deleteComment (id) {
			axios
				.delete(`https://blog-nuxt-9b0a0.firebaseio.com/comments/${id}.json`)
